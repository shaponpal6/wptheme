...
function firsttheme_post_metabox_html($post) {
    ...
    wp_nonce_field( 'firsttheme_update_post_metabox', 'firsttheme_update_post_nonce' );
    ?>
    <p>
        <label for="firsttheme_post_metabox_html"><?php esc_html_e( 'Post Subtitle', 'firsttheme' ); ?></label>
        <br />
        <input class="widefat" type="text" name="firsttheme_post_subtitle_field" id="firsttheme_post_metabox_html" value="<?php echo esc_attr( $subtitle ); ?>" />
    </p>
    <p>
