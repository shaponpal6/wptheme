...
$inline_styles_selectors = array (
    'a' => array(
        'color' => 'firsttheme_accent_colour',
    ),
    ':focus' => array(
        'outline-color' => 'firsttheme_accent_colour',
    ),
    '.c-post.sticky' => array(
        'border-left-color' => 'firsttheme_accent_colour',
    ),
    'button, input[type=submit], .header-nav .menu > .menu-item:not(.mega) .sub-menu .menu-item:hover > a' => array(
        'background-color' => 'firsttheme_accent_colour',
    )
);
